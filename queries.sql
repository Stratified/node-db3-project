...
SELECT o.id, o.orderDate, s.CompanyName Shipper FROM "Shipper" AS s
...
SELECT o.Id OrderId, c.CompanyName CustomersCompanyName, e.LastName EmployeeLastName FROM "Order" AS o
